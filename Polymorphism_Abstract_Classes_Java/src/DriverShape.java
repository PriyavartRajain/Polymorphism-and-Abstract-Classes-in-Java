...
// 		Downcasting from shape to Circle
//		Circle c1 = s1;					Type mismatch: cannot convert from Shape to Circle
		...
		Shape s3 = new Rectangle(1.0,2.0,"yellow",false);			//Upcast Rectangle to Shape
		System.out.println();
